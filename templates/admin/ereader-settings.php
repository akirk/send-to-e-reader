		...
		<tr>
			...
			<td>
				<fieldset>
					...
					<ul>
						<li><span class="description"><?php esc_html_e( 'Current page (only logged-in):', 'send-to-e-reader' ); ?></span> <span class="download-preview"><tt class="friends-sample-url"></tt><tt>?epub</tt></span></li>
						<?php
						foreach (
							array(
