...
?>
<tr>
	<th><?php esc_html_e( 'Automatic Sending', 'send-to-e-reader' ); ?></th>
	<td>
		<fieldset>
			<label for="automatic_sending">
				<select name="automatic_sending" id="automatic_sending">
					<option value=""<?php selected( $args['automatic_sending_day'], '' ); ?>><?php esc_html_e( 'No automatic sending', 'send-to-e-reader' ); ?></option>
			...
			<p class="description">
				<?php esc_html_e( 'Try to automatically send all new articles.', 'send-to-e-reader' ); ?>
			</p>
		</fieldset>
		<fieldset>
			<label for="automatic_sending_ereader">
				<select name="automatic_sending_ereader" id="automatic_sending_ereader">
					<option value=""<?php selected( $args['automatic_sending_ereader'], '' ); ?>><?php esc_html_e( 'No E-Reader selected', 'send-to-e-reader' ); ?></option>
			...
			<p class="description">
				<?php esc_html_e( 'Choose the E-Reader that this should be sent to. Only E-Mail based E-Readers are supported here.', 'send-to-e-reader' ); ?>
			</p>
		</fieldset>
	</td>
</tr>
